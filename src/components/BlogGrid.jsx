    ...
    <>
      ...
      <section className="w-full bg-[#3d1a22] border-t border-b border-[#e3d1b8]/10 px-4 py-8">
        <div className="max-w-screen-xl mx-auto">
          <button
            onClick={() => { navigate('/blog/welcome-to-the-new-definition-of-rnb'); window.scrollTo({ top: 0, behavior: 'smooth' }) }}
            className="w-full text-left group flex flex-col sm:flex-row sm:items-center justify-between gap-4 border border-[#e3d1b8]/12 bg-[#2a0f16] px-6 py-5 hover:border-[#e3d1b8]/28 transition-colors"
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h3
                  className="font-oswald font-bold text-[#e3d1b8]/85 uppercase leading-tight group-hover:text-[#e3d1b8] transition-colors"
            ...
            <span className="flex-shrink-0 flex items-center gap-1.5 font-oswald text-[10px] tracking-[0.2em] text-[#e3d1b8]/40 uppercase group-hover:text-[#e3d1b8]/70 transition-colors">
              Read <IconArrow />
            </span>
          </button>
        </div>
